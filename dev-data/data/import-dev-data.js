...
const importData=async()=>{
    ...
    try{
        ...
        await User.create(users,{validateBeforeSave:false}); // we are passing the array of objects and we are also passing the option that will disable the validation
